            ...
            <div className="card">
                ...
                <div className="body">
                    <div className="main-info">
                        <p className="title">Двохповерховий котедж • {props.metres} м<sup>2</sup></p>
                    ...
                    <div className="additional-info">
                        <div className="items-center">
                            ...
                            <p><span className="text">{props.rooms} </span>Кімнати</p>
                        </div>
                        <div className="items-center">
                            <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p><span className="text">{props.bathrooms} </span>Санвузли</p>
                        </div>
                    </div>
                </div>
                <div className="footer">
                    <div className="title">
                        <Link to={`/for-sale/object/${props._id}`}>Дізнатися більше</Link>
                    </div>
                    {/* <div className="contact-info"> */}
                        {/* <div className="avatar"></div>
                        <div>
                            <p className="name">Tiffany Heffner</p>
                            <p className="phone">(555) 555-4321</p>
                        </div> */}
                    {/* </div> */}
                </div>
            </div>
